// Mirrors cashlo-backend's src/utils/revalidateFrontend.js — same secret,
// same endpoint, same best-effort contract. Fires an on-demand ISR
// revalidation on cashlo-final after a post changes, instead of waiting up
// to 60s for the fetch-level revalidate window to expire.
